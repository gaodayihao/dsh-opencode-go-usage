window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\Program Files\dsh-opencode-go-usage-my\src\client\ocgo.module.css.mjs
		const css = ".siT6XW_wrap{display:inline-flex;position:relative}.siT6XW_chip{height:24px;color:var(--dsw-alias-label-primary,#0f1115);cursor:pointer;white-space:nowrap;user-select:none;background:0 0;border:0;border-radius:999px;align-items:center;gap:6px;padding:0 6px 0 8px;font-size:12px;line-height:1;transition:background-color .12s;display:inline-flex}.siT6XW_chip:hover,.siT6XW_chipOpen{background:var(--dsw-alias-interactive-bg-hover,#2631480f)}.siT6XW_seg{align-items:baseline;gap:3px;display:inline-flex}.siT6XW_segSep{opacity:.45}.siT6XW_logo{flex:none;display:inline-flex}.siT6XW_chevron{color:var(--dsw-alias-label-caption,#81858c);flex:none;transition:transform .12s;display:inline-flex}.siT6XW_chevronOpen{transform:rotate(180deg)}.siT6XW_segWarn50{color:var(--dsw-static-amber-400,#f7ad31)}.siT6XW_segWarn60{color:var(--dsw-static-amber-500,#f59e0b)}.siT6XW_segWarn70{color:var(--dsw-static-amber-600,#dd8629)}.siT6XW_segErr80{color:var(--dsw-alias-state-error-primary,#dc2626)}.siT6XW_segCrit90{color:var(--dsw-alias-state-error-primary,#dc2626);font-weight:600}.siT6XW_details{z-index:40;border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-specific-menu,#fff);min-width:220px;color:var(--dsw-alias-label-primary,#0f1115);box-shadow:var(--dsw-shadow-lv3,0 4px 12px #00000014);border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;font-size:12px;display:flex;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.siT6XW_window{justify-content:space-between;align-items:center;gap:12px;display:flex}.siT6XW_windowLabel{color:var(--dsw-alias-label-secondary,#61666b);opacity:.9;align-items:center;gap:6px;display:inline-flex}.siT6XW_windowValue{font-variant-numeric:tabular-nums;align-items:baseline;gap:6px;display:inline-flex}.siT6XW_windowReset{opacity:.65;font-variant-numeric:tabular-nums;font-size:11px}.siT6XW_foot{border-top:1px solid var(--dsw-alias-border-l1,#0000000a);justify-content:space-between;align-items:center;gap:8px;padding-top:6px;font-size:11px;display:flex}.siT6XW_footRight{align-items:center;gap:8px;margin-left:auto;display:inline-flex}.siT6XW_setBtn{color:var(--dsw-alias-state-business-primary,#3964fe);cursor:pointer;background:0 0;border:0;padding:0;font-size:11px}.siT6XW_setBtn:hover{text-decoration:underline}.siT6XW_fetchedAt{opacity:.6}.siT6XW_refreshBtn{color:var(--dsw-alias-state-business-primary,#3964fe);cursor:pointer;background:0 0;border:0;padding:0;font-size:11px}.siT6XW_refreshBtn:hover{text-decoration:underline}.siT6XW_setPanel{flex-direction:column;gap:8px;min-width:260px;display:flex}.siT6XW_field{flex-direction:column;gap:3px;display:flex}.siT6XW_fieldLabel{color:var(--dsw-alias-label-secondary,#61666b);opacity:.75;font-variant-numeric:tabular-nums;font-size:11px}.siT6XW_fieldInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2,#0000001a);background:var(--dsw-alias-bg-layer-1,#fff);width:100%;color:var(--dsw-alias-label-primary,#0f1115);font-variant-numeric:tabular-nums;border-radius:6px;outline:none;height:26px;padding:0 8px;font-size:12px}.siT6XW_fieldInput:focus{border-color:var(--dsw-alias-state-business-primary,#3964fe)}.siT6XW_setHint{opacity:.55;font-size:11px}.siT6XW_errorText{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:normal;max-width:240px;font-size:11px}";
		...
		var ocgo_module_css_default = {
			"chevron": "siT6XW_chevron",
			"chevronOpen": "siT6XW_chevronOpen",
			"chip": "siT6XW_chip",
			"chipOpen": "siT6XW_chipOpen",
			"details": "siT6XW_details",
			"errorText": "siT6XW_errorText",
			"fetchedAt": "siT6XW_fetchedAt",
			"field": "siT6XW_field",
			"fieldInput": "siT6XW_fieldInput",
			"fieldLabel": "siT6XW_fieldLabel",
			"foot": "siT6XW_foot",
			"footRight": "siT6XW_footRight",
			"logo": "siT6XW_logo",
			"refreshBtn": "siT6XW_refreshBtn",
			"seg": "siT6XW_seg",
			"segCrit90": "siT6XW_segCrit90",
			"segErr80": "siT6XW_segErr80",
			"segSep": "siT6XW_segSep",
			"segWarn50": "siT6XW_segWarn50",
			"segWarn60": "siT6XW_segWarn60",
			"segWarn70": "siT6XW_segWarn70",
			"setBtn": "siT6XW_setBtn",
			"setHint": "siT6XW_setHint",
			"setPanel": "siT6XW_setPanel",
			"window": "siT6XW_window",
			"windowLabel": "siT6XW_windowLabel",
			"windowReset": "siT6XW_windowReset",
			"windowValue": "siT6XW_windowValue",
			"wrap": "siT6XW_wrap"
		};
		//#endregion
